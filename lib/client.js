...
function DesktopSettingsPanel() {
  ...
  const refreshDepStatus = (0, import_react3.useCallback)(async () => {
    try {
      const r = await invoke3("list_profile_dependency_status");
  ...
  const handleRebuildDeps = (profile) => {
    ...
    void invoke3("rebuild_profile_dependencies", { profile }).then(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { "data-desktop-settings": "", style: ROOT_STYLE, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(SectionBox, { title: "\u4F9D\u8D56\u72B6\u6001\uFF08pnpm store \u4E00\u81F4\u6027\uFF09", children: [
      ...
      depProfiles === null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: NOTE_STYLE, children: "\u8BFB\u53D6\u5931\u8D25\uFF08\u4EC5\u684C\u9762\u58F3\u53EF\u7528\uFF09" }) : depProfiles.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: NOTE_STYLE, children: "\u672A\u53D1\u73B0 profile" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("table", { style: { width: "100%", fontSize: 12, borderCollapse: "collapse" }, children: [
...
var FuseErrorBoundary = class extends import_react4.default.Component {
  state = { error: null };
  ...
  componentDidCatch(error, info) {
    ...
    try {
      void invoke4("log_diag", { msg: `[plugin-fuse] \u9762\u677F\u6E32\u67D3\u5F02\u5E38\uFF1A${detail}` });
    } catch {
    }
  }
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-plugin-fuse": "1", style: { fontSize: 12.5, lineHeight: 1.6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { color: "var(--dsw-alias-state-danger-primary,#e5534b)" }, children: [
          "\u63D2\u4EF6\u4FDD\u9669\u4E1D\u9762\u677F\u6E32\u67D3\u5931\u8D25\uFF1A",
          String(this.state.error.message ?? this.state.error)
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { color: "var(--dsw-alias-label-secondary,#9aa4b2)", marginTop: 4 }, children: "\u8BE6\u60C5\u5DF2\u5199\u5165\u5E94\u7528\u65E5\u5FD7\uFF08~/.dsh/dsh-desktop-webview.log\uFF09" })
      ] });
    }
    return this.props.children;
  }
};
function FusePanelSafe() {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FuseErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FusePanel, {}) });
}
function FusePanel() {
  usePanelStyles();
  ...
  const [settings, setSettings] = import_react4.default.useState(null);
        ...
        if (settings && settings.ai_provider !== "custom" && fuseConnection) {
          ...
          const resp = await Promise.race([
            ...
            new Promise((_, reject) => {
              setTimeout(() => reject(new Error("\u89E3\u8BFB\u8D85\u65F6\uFF0875 \u79D2\u65E0\u54CD\u5E94\uFF09")), 75e3);
            })
          ]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        showSettings && settings ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          SettingsBody,
          {
            settings,
            providerDir,
...
function SettingsBody({
  ...
  const selProvider = Array.isArray(providerDir) ? providerDir.find((p) => p.id === settings.ai_provider) : void 0;
      ...
      children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { display: "flex", gap: 6, alignItems: "center" }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: settings.max_retries }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "button",
                  {
                    type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: [
            settings.exclude.map((x) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              "span",
              {
                className: "pf-chip",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProviderSelect, { providerDir, value: settings.ai_provider, onChange: onChangeProvider }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "div",
          {
            style: {
