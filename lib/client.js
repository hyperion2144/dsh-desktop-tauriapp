...
function DownloadsHeaderButton() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_dsh_client_ui_primitives.Button,
    {
      variant: "ghost",
      size: "sm",
      icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconDownloadOutline16, {}),
      title: "\u4E0B\u8F7D\u7BA1\u7406\u5668",
      "aria-label": "\u4E0B\u8F7D\u7BA1\u7406\u5668",
      onClick: () => {
        ...
        guide: [
          {
            ...
            icon: import_dsh_client_ui_primitives.IconDownloadOutline16
          }
        ]
      }));
      own(slots.inject(
...
function DesktopSettingsPanel() {
  ...
  const handleMigrate = () => {
    ...
    const run = (overwrite) => {
      ...
      return invoke3("migrate_profile", {
  ...
  const handleSwitchRuntime = (version) => {
    void nsSave({ dsh_runtime: version, dsh_mode: "builtin" }).then(() => invoke3("restart_dsh_service")).then(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { "data-desktop-settings": "", style: ROOT_STYLE, children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        !installed ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                          PfBtn,
                          {
                            variant: "ghost",
                          ...
                          PfBtn,
                          {
                            ...
                            children: runtimeCatalog.selected === c.version ? "\u4F7F\u7528\u4E2D" : "\u5207\u6362\u5230\u6B64\u7248\u672C"
                          }
                        )
                      ]
                    }
    ...
    msg && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: msg.ok ? SUCCESS_NOTE_STYLE : DANGER_MSG_STYLE, children: msg.text }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    ...
    explainText === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "div",
      {
        ...
        children: "AI \u89E3\u8BFB\u4E2D\u2026\uFF08deepseek-v4-flash\uFF09"
      }
